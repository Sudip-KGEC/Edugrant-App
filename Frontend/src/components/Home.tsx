...
import CelebrateLogo from './CelebrateLogo'

const Home = ({ t, setView, handleLoginStart, currentUser }) => {


  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center space-y-8 pb-12 scrollbar-hide">
      <div className="relative">
        <div className="absolute -inset-1 rounded-full bg-teal-400 blur opacity-20 animate-pulse mt-6"></div>
        <CelebrateLogo />
      </div>
